...
class Instructor extends Lambdasian {
  constructor(Par){
    super(Par);
    this.specialty = Par.specialty;
    this.favLanguage = Par.favLanguage;
    this.catchPhrase = Par.catchPhrase;
...
class Student extends Lambdasian {
  constructor(Par){
    super(Par);
    this.previousBackground = Par.previousBackground;
    this. className = Par.className;
    this.favSubjects = Par.favSubjects;
  }
  listSubjects(){
    return `Love ${this.favSubjects}`;
  }
...
class ProjectManager extends Instructor {
  constructor(Par){
    super(Par);
    this. gradClassName = Par.gradClassName;
